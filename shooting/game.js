...
function updateBots(dt){
  ...
  for(const b of game.entities){
    ...
    b.root.rotation.y=Math.atan2(dir.x,dir.z)+Math.PI;const bf=b.root.position.y;const oldX=b.root.position.x,oldZ=b.root.position.z;b.navRepath-=dt;
